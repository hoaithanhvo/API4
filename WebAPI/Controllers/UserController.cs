...
namespace WebAPI.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(NIDEC_IOT_TESTContext context , IOptionsMonitor<AppSetting>optionsMonitor) { 
            _context= context;
        ...
        public async Task<IActionResult> ReNewToken(TokenModel model)
        {
            ...
            {
                return BadRequest(new ApiRespones
                {
                    Success = false,
